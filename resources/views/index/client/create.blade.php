...
<section class="rt_wrap content mCustomScrollbar">
     ...
     @csrf
          <div class="rt_content">
               ...
               <input type="text" name="client_name" class="textbox textbox_225" placeholder="客户名称"/>
               <!-- <span class="errorTips">错误提示信息...</span> -->
               </li>
               <li>
               <span class="item_name" style="width:120px;">客户编码：</span>
               <input type="text" name="client_ma" class="textbox textbox_225" placeholder="客户编码"/>
               <!-- <span class="errorTips">错误提示信息...</span> -->
               <span class="item_name" style="width:120px;">客户简称：</span>
               <input type="text" name="client_jian" class="textbox textbox_225" placeholder="客户简称"/>
               <!-- <span class="errorTips">错误提示信息...</span> -->
               </li>
               <li>
               <span class="item_name" style="width:120px;">手机号码：</span>
               <input type="tel" name="tel" class="textbox textbox_225" placeholder="手机号码..."/>
               <!-- <span class="errorTips">错误提示信息...</span> -->
               <span class="item_name" style="width:120px;">传真：</span>
               <input type="text" name="chuanzhen" class="textbox textbox_225" placeholder="传真..."/>
               <!-- <span class="errorTips">错误提示信息...</span> -->
               </li>
               <li>
               <span class="item_name" style="width:120px;">网址：</span>
               <input type="tel" name="httpd" class="textbox textbox_225" placeholder="网址..."/>
               <!-- <span class="errorTips">错误提示信息...</span> -->
               <span class="item_name" style="width:120px;">电子邮箱：</span>
               <input type="email" name="email" class="textbox textbox_225" placeholder="电子邮件地址..."/>
               <!-- <span class="errorTips">错误提示信息...</span> -->
               </li>
               <li>
               <span class="item_name" style="width:120px;">地区：</span>
               <input type="text" name="country" class="textbox textbox_225" placeholder="地区...">
               <span class="item_name" style="width:120px;">邮政编码：</span>
               <input type="text" name="mail" class="textbox textbox_225" placeholder="邮政编码..."/>
               <!-- <span class="errorTips">错误提示信息...</span> -->
               </li>
               <li>
               <span class="item_name" style="width:120px;">详细地址：</span>
               <textarea type="text" name="dateil" class="textbox textbox_225" placeholder="详细地址..."/></textarea>
               <!-- <span class="errorTips">错误提示信息...</span> -->
               </li>
               <hr>
               <div class="page_title">
               ...
               <textarea type="text" name="desc" class="textbox textbox_225" placeholder="企业描述..."/></textarea>
               <!-- <span class="errorTips">错误提示信息...</span> -->
               </li>
               <hr>
               <div class="page_title">
               ...
               <textarea type="text" name="one" class="textbox textbox_225" placeholder="备注1..."/></textarea>
               <!-- <span class="errorTips">错误提示信息...</span> -->
               </li>
               <li>
               <span class="item_name" style="width:120px;">备注2：</span>
               <textarea type="text" name="two" class="textbox textbox_225" placeholder="备注2..."/></textarea>
               <!-- <span class="errorTips">错误提示信息...</span> -->
               </li>
               <li>
